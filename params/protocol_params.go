...
var (
	...
	DurationLimit          = big.NewInt(13)                    // Time of the block The decision boundary on the blocktime duration used to determine whether difficulty should go up or not.
)
